...
export default class ViewPaper2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      show: true,
        ...
        {this.state.show ? (
          ...
          <ScrollView>
            <Image
              ...
              source={{ uri: 'http://i68.tinypic.com/2a6qxd3.png' }}
            />
            <Image style={{width:width,height:height/1.92}} 
      source={{uri:'http://i68.tinypic.com/iqfo1v.png'}}/>
            <Image style={{width:width,height:height/1.92}} 
      source={{uri:'http://i68.tinypic.com/2e34gb6.png'}}/>
         </ScrollView>
        )}
        </View>
    );
